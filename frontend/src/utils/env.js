export function getAppBasePath() {
  ...
  const routerPaths = [
    ...
    '/feature/hrms/bulk-operations',
    '/feature/hrms/recruitment',
    '/feature/hrms',
    '/feature/inventory/products',
    '/feature/inventory/warehouses',
    '/feature/inventory/orders',
    '/feature/inventory/logs',
    '/feature/inventory/suppliers',
    '/feature/inventory/couriers',
    '/feature/inventory/sales-orders',
    '/feature/inventory/bulk-operations',
    '/feature/inventory',
    '/feature/accounting/suppliers',
    '/feature/accounting/accounts',
    '/feature/accounting/journals',
    '/feature/accounting/invoices',
    '/feature/accounting/bills',
    '/feature/accounting/transactions',
