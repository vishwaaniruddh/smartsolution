...
import Apps from './pages/superadmin/Apps';
import Login from './pages/Login';
import ResetPassword from './pages/ResetPassword';
import SADashboard from './pages/sales_associate/SADashboard';
import SAMyLeads from './pages/sales_associate/SAMyLeads';
import SAPipeline from './pages/sales_associate/SAPipeline';
import SATasks from './pages/sales_associate/SATasks';
...
const ProtectedRoute = ({ children, allowedRoles = [] }) => {
  ...
  if (allowedRoles.length > 0 && !allowedRoles.includes(user.role)) {
    ...
    if (user.role === 'Sales Associate') return <Navigate to="/sa/dashboard" replace />;
