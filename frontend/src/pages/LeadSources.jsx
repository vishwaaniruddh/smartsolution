...
const LeadSources = () => {
  ...
  const fetchSources = () => {
    setLoading(true);
    fetch(`http://localhost/lead/api/lead_sources.php?tenant_id=${tenantId}`)
      .then(res => res.json())
      .then(data => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost/lead/api/lead_sources.php', {
      method: method,
  ...
  const handleDelete = async (id, name) => {
    ...
    fetch(`http://localhost/lead/api/lead_sources.php?id=${id}&tenant_id=${tenantId}`, {
      method: 'DELETE'
    })
      .then(res => res.json())
      .then(data => {
